"""
Django settings for snowy_snowflake_dev_67316 project.
...
ROOT_URLCONF = 'snowy_snowflake_dev_67316.urls'
...
WSGI_APPLICATION = 'snowy_snowflake_dev_67316.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snowy_snowflake_dev_67316 API",
    "DESCRIPTION": "API documentation for snowy_snowflake_dev_67316 App",
    "VERSION": "v1",
}
