...
## Project Structure
    ...
    ├── snowy_snowflake_dev_67316  # Django project configurations
...
1. Clone this repo and `cd snowy_snowflake_dev_67316`
...
2. Clone this repo and `cd snowy_snowflake_dev_67316`
